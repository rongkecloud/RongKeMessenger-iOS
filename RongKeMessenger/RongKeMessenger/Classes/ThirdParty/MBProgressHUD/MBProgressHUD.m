...
- (void)layoutSubviews {
    ...
    CGRect rect = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObject:detailsLabel.font forKey: NSFontAttributeName] context:nil];
    CGSize detailsLabelSize = CGSizeMake(rect.size.width, rect.size.height);  // add by ivan
