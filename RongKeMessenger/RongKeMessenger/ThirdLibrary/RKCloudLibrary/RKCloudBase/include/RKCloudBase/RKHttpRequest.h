...
//  云视互动SDK
//
//  Created by GrayWang on 15/3/17.
//  Copyright (c) 2015年 西安融科通信技术有限公司. All rights reserved.
//

#import <Foundation/Foundation.h>

@protocol RKHttpKitDelegate;

@interface RKHttpRequest : NSObject
...
@property (nonatomic, assign) id <RKHttpKitDelegate> rkHttpKitDelegate; // HTTP Client请求API使用的代理
